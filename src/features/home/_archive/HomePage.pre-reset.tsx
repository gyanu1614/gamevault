...
export function HomePage() {
  ...
  return (
    ...
    >
      ...
      {/* ================================================================
          PAGE RHYTHM — one flex container owns ALL vertical spacing
          between sections. Sections contain content; they never space
          themselves. Flex `gap` (not space-y) because the responsive
          split hides whole sections at each breakpoint, and gap ignores
          display:none children while space-y leaves phantom margins.
          ================================================================ */}
      <div className="relative z-10 flex flex-col gap-20 sm:gap-32">
      ...
      <section className="max-lg:hidden relative flex flex-col h-[calc(100svh-160px)] min-h-[480px] px-6">
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="max-lg:hidden relative">
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section id="marketplace-rail" className="relative overflow-x-clip">
        ...
        <img
          ...
          alt=""
          aria-hidden
          className="pointer-events-none absolute left-1/2 top-0 z-0 hidden w-[1240px] max-w-none -translate-x-1/2 select-none object-contain opacity-[0.26] [mask-composite:intersect] [mask-image:linear-gradient(to_bottom,transparent,black_14%,black_38%,transparent_88%),linear-gradient(to_right,transparent,black_10%,black_90%,transparent)] md:block"
        />
      ...
      {/* The py-20 here is intra-section composition, NOT inter-section
          rhythm: TopUpsBanner is an absolute backdrop sized by this
          section's box, so the content inset is what gives the banner
          art room above and below the copy. It lives on the content
          wrapper, never on the section boundary. */}
      <section id="top-ups" className="max-lg:hidden relative overflow-x-clip">
        <TopUpsBanner />
        <div className="max-w-container mx-auto px-6 py-20 relative z-10">
          <RowHeader
      ...
      <section className="relative overflow-x-clip">
        {/* Aurora blobs — slow drifting lime + cool-blue wash. They
            extend past this section vertically ON PURPOSE: the page is
            one surface, so ambient light crosses section boundaries
      ...
      {/* Payment methods marquee — mobile only */}
