  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ═══ ZONE 2 (scroll region): the four-step setup card ═══
             (Activity/announcements panel intentionally removed for now — it
             returns once the setup steps are done.) */}
        ...
        <div className="mt-5 shrink-0">
          <div
            className="flex items-center gap-3.5 rounded-lg border bg-white p-3.5"
            style={{ borderColor: PALETTE.line, boxShadow: '0 2px 8px rgba(20,67,42,0.04)' }}
          >
            <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg" style={{ backgroundColor: '#5865F2' }}>
              <DiscordGlyph />
            </span>
            <div className="min-w-0 flex-1">
              <div className="text-[13.5px] font-semibold" style={{ color: PALETTE.ink }}>
                {hasDiscord ? 'You’re In The DropMarket Discord' : 'Join DropMarket’s Discord'}
              </div>
              <div className="mt-0.5 text-[12px]" style={{ color: PALETTE.ink2 }}>
                Meet other sellers, get price tips, and hear it here first.
              </div>
            </div>
            <a
              href={discordUrl}
              ...
              className="shrink-0 whitespace-nowrap rounded-md border px-4 py-2.5 text-[12.5px] font-semibold transition-colors hover:brightness-95"
