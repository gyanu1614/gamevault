    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Your seller account restriction information</p>
        </div>
        ...
        >
          <div className="flex items-start gap-6">
            ...
            <div className={cn(
              ...
              {isActive && <CheckCircle className="h-8 w-8 text-green-400" />}
              {isRestricted && <ShieldAlert className="h-8 w-8 text-yellow-400" />}
              {isBanned && <Ban className="h-8 w-8 text-red-400" />}
            </div>
            ...
            <div className="flex-1">
                ...
                <>
                  ...
                  {profile.seller_restriction_reason && (
                    <div className="bg-black/30 rounded-lg p-4 mb-4">
                      <p className="text-sm font-medium text-yellow-400 mb-2">Restriction Reason:</p>
                      <p className="text-sm text-gray-300">{profile.seller_restriction_reason}</p>
                    </div>
                  )}
                </>
              )}
              ...
              {isBanned && (
                <>
                  ...
                  {profile.seller_restriction_reason && (
                    <div className="bg-black/30 rounded-lg p-4 mb-4">
                      <p className="text-sm font-medium text-red-400 mb-2">Ban Reason:</p>
                      <p className="text-sm text-gray-300">{profile.seller_restriction_reason}</p>
                    </div>
                  )}
                </>
          ...
          <div className="space-y-3">
            {isActive && (
              <>
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-gray-300">You can create and publish new listings</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-gray-300">You can manage your existing listings</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-gray-300">You have full access to seller dashboard</p>
                </div>
              </>
            )}
            ...
            {isRestricted && (
              <>
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-gray-300">You cannot create new listings</p>
                </div>
                <div className="flex items-start gap-3">
                  <Ban className="h-5 w-5 text-red-400 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-gray-300">You cannot publish or make listings live</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-gray-300">You can view your existing listings (read-only)</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-gray-300">You can access your seller dashboard (limited)</p>
                </div>
              </>
            )}
            ...
            {isBanned && (
              <>
                <div className="flex items-start gap-3">
                  <Ban className="h-5 w-5 text-red-400 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-gray-300">You cannot access seller features</p>
                </div>
                <div className="flex items-start gap-3">
                  <Ban className="h-5 w-5 text-red-400 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-gray-300">You cannot create or manage listings</p>
                </div>
                <div className="flex items-start gap-3">
                  <Ban className="h-5 w-5 text-red-400 flex-shrink-0 mt-0.5" />
                  <p className="text-sm text-gray-300">Your existing listings are hidden from buyers</p>
                </div>
              </>
            )}
          </div>
            ...
            <div className="space-y-3">
              {restrictions.map((restriction: any) => (
                ...
                >
                  ...
                  {restriction.reason && (
                    <p className="text-sm text-gray-400 mb-2">{restriction.reason}</p>
                  )}
