/**
 * SafeDrop Badge Component
 *
 * Displays SafeDrop protection level badge
...
export type SafeDropLevel = 'standard' | 'enhanced' | 'premium'

interface SafeDropBadgeProps {
  level: SafeDropLevel
  orderValue?: number
  size?: 'sm' | 'md' | 'lg'
  showLabel?: boolean
