  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-8">
      <div className="max-w-4xl w-full">
        {/* Main Card */}
        <div className="bg-gradient-to-br from-violet-500/10 via-purple-500/10 to-pink-500/10 border border-violet-500/20 rounded-2xl p-12 text-center">
          {/* Icon */}
          <div className="w-20 h-20 mx-auto mb-6 bg-violet-500/20 rounded-full flex items-center justify-center">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-500 hover:to-purple-500 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-violet-500/20 hover:shadow-violet-500/40 transform hover:scale-105"
          >
            Start Selling Now
        ...
        <div className="mt-8 grid grid-cols-3 gap-4 max-w-2xl mx-auto">
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-violet-400">$2M+</div>
            <div className="text-xs text-gray-400">Monthly Volume</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-violet-400">4.8★</div>
            <div className="text-xs text-gray-400">Avg Seller Rating</div>
          </div>
        </div>
      </div>
    </div>
