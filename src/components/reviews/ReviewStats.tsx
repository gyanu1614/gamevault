...
export default function ReviewStats({
  ...
  return (
    <div className={cn('bg-white/[0.03] border border-white/[0.08] rounded-xl p-6', className)}>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-lg font-bold text-green-400">{Math.round(positivePercentage)}%</span>
            </div>
          ...
          <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-lg font-bold text-red-400">{negativePercentage}%</span>
            </div>
      ...
      {totalReviews === 0 && (
        <div className="py-8 text-center">
          ...
          <p className="text-xs text-gray-500 mt-1">Be the first to leave a review!</p>
        </div>
      )}
    </div>
  )
