...
**Date:** 2026-09-25 · **Branch:** `fix/sell-security` (worktree `../gamevault-sell-security`, stack slot 34) · **PR:** _(link below)_ · **Not merged, no `db push`, nothing emailed.** One commit per finding; audit = `docs/audit/sell-full-audit.md` §4–5.
